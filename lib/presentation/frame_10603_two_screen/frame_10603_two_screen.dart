...
class Frame10603TwoScreen extends StatelessWidget {
  @override
                ...
                child: RichText(
                  text: TextSpan(
                    children: [
                      TextSpan(
                        text:
                            "Deliver this shipment to the final destination that is 230 miles away from the pickup location Lorem ipsum dolor sit amet consectetur. Condimentum condimentum enim nibh donec habitant quis neque egestas eu. ",
                        style: TextStyle(
